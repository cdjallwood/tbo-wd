<?php include('includes/header.php'); ?>
	<section class="site-body">
		...
		<?php include('includes/featured-hero.php'); ?>

		<article class="m-info-block collapse-block-bottom">
			<div class="container">
				<header>
					<h2>The Speakers</h2>
				</header>
		...
		<article class="m-info-block about-block palm-reduced-block reduced-top-block">
			<div class="container">
				...
				<div class="l-grid-row">
					<div class="l-grid-8 t-grid-4 l-clear-1">
						...
						<p>However, you probably find many aspects of running your business hard work; winning clients, pricing your work, wouldn't it be great to have some help with this?</p>
					</div>
					<div class="l-grid-8 t-grid-4">
		...
		<article class="m-info-block blog-block">
			<div class="container">
				<header>
					<h2>The Business Blog</h2>
				</header>
...
a web design business</p>
				...
				<a href="#" class="m-btn btn-primary">Buy Tickets</a>
			</div>
		</article>
